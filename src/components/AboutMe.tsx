...
export default function AboutMe() {
    return (
        <div className='flex flex-col grow items-center justify-center '>
            ...
            <div className="flex flex-row flex-wrap mt-8 gap-2 bg-transparent p-4 rounded animate-fadeIn">
                ...
                <a href="https://nextjs.org/docs" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/nextjs-colored.svg"    width="36" height="36" alt="NextJs" className="invert-0 dark:invert"/></a>
  ...
  <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/express-colored.svg" width="36" height="36" alt="Express" className="invert-0 dark:invert" />
</a>
